...
map.set(CanvasType.GRID, {
    ...
    title: 'Grid',
    description: `<p>
                    This piece started out as a doodle,
                    ...
                    >
                        Richard Diebenkorn
                    </a>. The doodle evolved over time into a kind of grid, dancing
                ...
                <p>
                    ...
                    >
                        cellular automata
                    </a>, but turned on its head. Instead of writing an algorithm to
