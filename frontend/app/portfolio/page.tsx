        ...
        <ContentPageWrapper>
            <div className="underline-animation">
                ...
                <p className="w-full xl:w-[50%]">
                    ...
                    roles include: engineer, designer, UX designer, leader,
                    manager, or any combination of these. I will attempt to
                    clarify my role in each case.
                </p>
                ...
                <PortfolioSection
                    ...
                    description={
                        <>
                            <p>
                                This one is a bit different. It grew out of a
                                design challenge I participated in. Having spent
                                the last few decades designing for screens, I
                                decided I should fully embrace this opportunity
                                and design something I had never designed
                                before, so I decided to design a chair. The
                                symbolic world is great and all, but sometimes
                                it&apos;s nice to consider the real world.
                            </p>
                            <p>
                                The purpose of this design is to solve some of
                                the most common problems I have when sitting
                                down to read a good book. Namely:
                            </p>
                            <ul className="list-disc list-outside pl-4 [&>li]:mb-2">
                                <li>Comfortable for long periods</li>
                                <li>
                                    Built-in lighting that illuminates the pages
                                    of the book perfectly
                                </li>
                                <li>
                                    Plenty of space for drinks, snacks, glasses,
                                    and other items
                                </li>
                            </ul>
                    ...
                    description={
                        <>
                            <p>
                                ...
                                project was to create an AI Agent that could be
                                used to automate tasks in the H2O AI Cloud,
                                using a natural language interface. Users would
                                be able to create experiments, perform data
                                exploration, launch AI Engines for Driverless
                                AI, and more, all by interacting with the AI
                                Agent.
                            </p>
                        </>
                    }
                ...
                <PortfolioSection
                    ...
                    description={
                        <>
                            <p>
                                AI Governance is an important part of managing
                                the deployment of AI models in the enterprise.
                                Understanding model risk and health is critical
                                for business leaders to understand their risk
                                exposure.
                            </p>
                            <p>
                                The AI Governance project at H2O.ai was designed
                                to help Risk Management Officers understand at
                                the highest level what models they have
                                deployed, and to quantify the risks associated
                                with these models.
                            </p>
                        </>
                    }
                    ...
                    description={
                        <>
                            <p>
                                ...
                                documents, using combinations of models ranging
                                from OCR, layout models, and LLMs.
                            </p>
                        </>
                    }
                    company="H2O.ai"
                ...
                <PortfolioSection
                    ...
                    description={
                        <>
                            <p>
                                In 2019, H2O.ai embarked on an ambitious project
                                to build a cloud-based platform for AI. Named
                                simply{' '}
                                <a
                                    target="_blank"
                                ...
                                unified platform. Key components included
                                H2O&apos;s flagship products,{' '}
                                <a
                                    target="_blank"
                                ...
                                build apps using these tools and H2O&apos;s
                            ...
                            <p>
                                ...
                                development. I was initially tasked with leading
                ...
                <div className="p-[4rem_0] border-t border-b border-t-[var(--rule-bottom)] border-b-[var(--rule-top)]">
                    ...
                    <p>
                        ...
                        AI-powered auditing applications. Initially, my role was
                ...
                <PortfolioSection
                    ...
                    description={
                        <>
                            <p>
                                PwC&apos;s Cash.ai application is used
                                internally by PwC audit teams to accelerate the
                                audit process. It uses machine learning, machine
                                vision, and other AI processes to quickly and
                                accurately scan documents, extract their data,
                                and correlate this data with the audited
                                journals.
                            </p>
                            <p>
                    ...
                    description={
                        <>
                            ...
                            <p>
                                ...
                                centerpiece of the user experience are data
                                visualizations which display the results of the
                                models. These visualizations make it easy for
                                auditors to spot inconsistencies and unexpected
                                patterns.
                            </p>
                        </>
                    }
